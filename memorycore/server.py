...
# 内核已抽到 core/recall_fusion.py —— 与 prefetch 插件共用同一份实现
# (2026-09-18: 插件不再自己拼召回链, 避免副本漂移)。
# 预注册超参 (DESIGN-P2.md §1.3): 不得因 dev/holdout 结果调参。
# ---------------------------------------------------------------------------
from .core.recall_fusion import (  # noqa: E402
    CANDIDATE_K_DEFAULT as _RECALL_FUSION_CANDIDATE_K_DEFAULT,
    CANDIDATE_K_ENV as _RECALL_FUSION_CANDIDATE_K_ENV,
    CANDIDATE_K_MAX as _RECALL_FUSION_CANDIDATE_K_MAX,
    FUSION_ENV as _RECALL_FUSION_ENV,
    LEX_PRODUCT_LIMIT as _RECALL_FUSION_LEX_PRODUCT_LIMIT,
    OFF_VALUES as _RECALL_FUSION_OFF_VALUES,
    RRF_K as _RECALL_FUSION_RRF_K,
    W_DECAY as _RECALL_FUSION_W_DECAY,
    W_ENGINE as _RECALL_FUSION_W_ENGINE,
    W_LEX as _RECALL_FUSION_W_LEX,
    candidate_k as _recall_fusion_candidate_k,
    fuse_candidates as _fuse_recall_candidates,
    fusion_enabled as _recall_fusion_enabled,
    lex_score as _recall_fusion_lex_score,
)
